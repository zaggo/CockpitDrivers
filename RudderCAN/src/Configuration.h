...
// Axis deadbands, in percent of the calibrated travel they sitsneeds no re-tuning here.
...
const uint8_t kRudderCenterDeadbandPercent = 5;
...
const uint8_t kBrakeEndDeadbandPercent = 4;
